...
<?php
  ...
  $queryTSD1 = "SELECT count(*) AS tongsodong1 FROM reviews WHERE author LIKE '{$author}'";
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            ...
                            <div class="blog-list clearfix">
                                <h3>ĐÂY LÀ NHỮNG BÀI VIẾT CỦA TÁC GIẢ <?php echo $author;?></h3>
                                <?php 
                                    $queryAuthor = "SELECT * FROM reviews WHERE author LIKE '{$author}' ORDER BY review_id DESC LIMIT {$offset}, {$row_count}";
                                    $resultAuthor = $mysqli->query($queryAuthor);
                                    While($arAuthor = mysqli_fetch_assoc($resultAuthor)){
                                        $nameReview = $arAuthor['name'];
                                        $preview_text = $arAuthor['preview_text'];
                                        $created_at = $arAuthor['created_at'];
                                        $counter = $arAuthor['counter'];
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="single.php" title=""><?php echo $nameReview;?></a></h4>
                                    ...
                                    <ul class="pagination justify-content-start">
                                         <li class="<?php if($current_page<= 1){ echo 'disabled'; } ?>">
                                             <a href="<?php if($current_page <= 1){ echo '#'; } else {
                                              echo "author.php?page=".($current_page - 1); } ?>">prev</a>
                                        <li class="page-item"><a class="page-link" href="author.php?page=1">1</a></li>
                                        <li class="page-item"><a class="page-link" href="author.php?page=2">2</a></li>
                                        <li class="page-item"><a class="page-link" href="author.php?page=3">3</a></li>
                                        <li class="page-item"><a class="page-link" href="">...</a></li>
                                        <li class="page-item"><a class="page-link" href="author.php?page=<?php echo $tongsotrang;?>">trang cuối(<?php echo $tongsotrang;?>)</a></li>
                                        <li class="page-item">
                                             <a class="<?php if($current_page >= $tongsotrang){ echo 'disabled'; } ?>">
                                             <a href="<?php if($current_page >= $tongsotrang){ echo '#'; } else { 
                                               echo "author.php?page=".($current_page + 1); } ?>">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div><!-- end col -->
