                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="comments-list">
                                            ...
                                            <?php $query1 = "SELECT * FROM comment WHERE newspaper_id = {$id} ORDER BY comment_id DESC LIMIT 5";
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form class="form-wrapper" method="POST">
                                            <input type="text" class="form-control" placeholder="newspaper_id" value="<?php echo $id;?>" id="newspaper_id1">  
                                            <input type="text" class="form-control" placeholder="Your name" value="" id="name1">
                                            <input type="text" class="form-control" placeholder="Email address" value="" id="email1">
                                            <input type="text" class="form-control" placeholder="Website" value="" id="website1">
                                            <textarea class="form-control" placeholder="Your comment" value="" id="comment1"></textarea>
                                            <a href="javascript:void(0)" title="" onclick="getInfo()">Submit Comment</a>
                                            <script type="text/javascript">
			                                   function getInfo(){
                                                ...
                                                var newspaper_id = <?php echo $id;?>;
				                                          // name1:value1, name2: value2,...
				                                    $.ajax({
		                                                url: 'ajax.php',
		                                                type: 'POST',
		                                                cache: false,
		                                                data: {anewspaper_id:newspaper_id, aname:name, aemail:email, awebsite:website, acomment:comment},
